...
"""Docstring: Short title and summary on first line followed by a new line style_guide.py 
A Docstring should be usable as a 'Usage:' message. It should contain: 
A description of the script's function; command-line syntax and parameters; 
notes about the algorithm used and a decent usage example. 
...
__date__ = "8-14-2018" 
__maintainer__ = "maintainer@lucascavalare.com" 
